...
const LandingRightSideSection = ({ data }: { data: any }) => {
  return (
    <div>
      ...
      <div className="space-y-5 grid grid-cols-2 mb-5 mt-5 gap-5 xl:space-y-6 md:grid-cols-none md:mb-10 md:gap-0 xl:mt-7 xl:mb-[60px]">
      ...
      <div className="space-y-5 mt-10 xl:mt-[60px] xl:space-y-7">
